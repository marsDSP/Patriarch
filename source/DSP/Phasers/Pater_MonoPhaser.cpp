...
MonoPhaser::MonoPhaser (foleys::MagicProcessorState& magicState, String prefix)
{
...
void MonoPhaser::addParameters (Parameters& params, String prefix, float modRange)
{
...
void MonoPhaser::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void MonoPhaser::releaseResources()
{
}

void MonoPhaser::processBlock (const float* input, float* modOut, float* noModOut, const int numSamples)
{
